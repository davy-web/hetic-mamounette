...
jQuery(document).ready(function ($) {
  var allCards = $(".c-card .card-likeable");
  var eventLoad = false; // get post in favorite

  getFavorite().then(function (_) {
    return eventLoad = true;
  }); // add listener on click favorite

  $(allCards).each(function () {
    $(this).on("click", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
        var likeId, myInputs, checkIsInFavorite, doAction;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                eventLoad = true;
                likeId = $(this).prev().attr("data-id");
                myInputs = $("[data-id=" + likeId + "]");
                checkIsInFavorite = $(myInputs[0]).hasClass("favorite");
                doAction = checkIsInFavorite ? "remove" : "add";
                _context.next = 9;
                return RemoveOrAddInFavorite(likeId, doAction, myInputs);
  ...
  function RemoveOrAddInFavorite(_x2, _x3, _x4) {
    return _RemoveOrAddInFavorite.apply(this, arguments);
  } // ajax get post 


  function _RemoveOrAddInFavorite() {
    _RemoveOrAddInFavorite = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(likeId, doAction, myInputs) {
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return $.ajax({
                ...
                type: 'POST',
                data: "action=add_remove_favorite&postId= ".concat(likeId, "&do=").concat(doAction),
  ...
  function _getFavorite() {
    _getFavorite = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
                ...
                success: function success(result) {
                  if (result != "error") {
                    for (var j = 0; j < result.length; j++) {
                      var idFavorite = result[j]['post_id'];
                      var myInputs = $("[data-id=" + idFavorite + "]");

                      for (var i = 0; i < myInputs.length; i++) {
                        var element = myInputs[i];

                        if ($(element).hasClass("like-badge-".concat(idFavorite))) {
                          $(element).prop("checked", "true");
                          $(element).addClass("favorite");
                          $(element).closest("article.c-card").addClass("cardIsLove");
                        }
